    ...
    <div className="rounded-xl p-4" style={{ background: '#171721', border: '1px solid rgba(255,255,255,0.08)' }}>
      ...
      <ResponsiveContainer width="100%" height={200}>
        <LineChart data={data}>
          ...
          <Line type="monotone" dataKey="visitas" stroke="#d9c2a0" strokeWidth={2} dot={false} name="Visitas" />
          <Line type="monotone" dataKey="simulaciones" stroke="#c9a876" strokeWidth={2} dot={false} name="Simulaciones" />
        </LineChart>
      </ResponsiveContainer>
    </div>
  )
